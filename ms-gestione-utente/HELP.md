...
* The original package name 'it.pa.repdgt.survey-mgmt' is invalid and this project uses 'it.pa.repdgt.surveymgmt' instead.
...
```
$ docker run --rm -p 8080:8080 survey-mgmt:0.0.1-SNAPSHOT
```
