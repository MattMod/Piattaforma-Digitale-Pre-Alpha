  ...
  const userDropDown = () => (
    ...
    >
      <DropdownToggle caret className='complementary-1-color-a1 shadow-none'>
        ...
        >
          <div
            className='rounded-circle bg-white d-flex align-items-center justify-content-center mr-3'
        ...
        {isHeaderFull && (
          ...
          >
            <div className='container d-flex align-items-center'>
              <Button onClick={() => setIsOpen(true)} className='primary-bg-a6'>
                <Icon icon='it-burger' size='sm' color='white' />
              </Button>
              <div
                className={clsx(
